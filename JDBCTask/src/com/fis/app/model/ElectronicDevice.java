...
public class ElectronicDevice {
	...
	public ElectronicDevice(int deviceId, int cost) {
		super();
		this.deviceId = deviceId;
		this.cost = cost;
	}

	public ElectronicDevice(String deviceType, int deviceId, String brandName,
	...
	public String toString() {
		return "ElectronicDevice [deviceType=" + deviceType + ", deviceId="
