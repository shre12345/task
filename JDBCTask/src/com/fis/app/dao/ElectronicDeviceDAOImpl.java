...
public class ElectronicDeviceDAOImpl implements IElectronicDeviceDAO {
	...
	String deleteEntry="delete from eledevice.device where deviceId=?";
	String displayBasedType="select * from eledevice.device group by brandName,deviceType";
	String countType="select deviceType,count(deviceType)as Count from eledevice.device group by deviceType";
...
//	}
	...
	@Override
	public List<ElectronicDevice> geDevicesBasedOnPriceRangeandType(int range1,int range2, String type, List<ElectronicDevice> ls) throws SQLException {
